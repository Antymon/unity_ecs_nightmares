...
public partial class GameEntity {
    ...
    public void AddDamage(int newHealthPointsDamaged) {
        var index = GameComponentsLookup.Damage;
        var component = CreateComponent<DamageComponent>(index);
        component.healthPointsDamaged = newHealthPointsDamaged;
        AddComponent(index, component);
    }

    public void ReplaceDamage(int newHealthPointsDamaged) {
        var index = GameComponentsLookup.Damage;
        var component = CreateComponent<DamageComponent>(index);
        component.healthPointsDamaged = newHealthPointsDamaged;
