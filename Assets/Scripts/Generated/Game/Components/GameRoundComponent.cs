...
public partial class GameContext {
    ...
    public GameEntity SetRound(int newCurrentRound) {
        if (hasRound) {
        ...
        entity.AddRound(newCurrentRound);
        return entity;
    }

    public void ReplaceRound(int newCurrentRound) {
        var entity = roundEntity;
        if (entity == null) {
            entity = SetRound(newCurrentRound);
        } else {
            entity.ReplaceRound(newCurrentRound);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddRound(int newCurrentRound) {
