...
public partial class GameEntity {
    ...
    public void AddHealth(int newHealthPoints, int newHealthPointsCap) {
        ...
        component.healthPointsCap = newHealthPointsCap;
        AddComponent(index, component);
    }

    public void ReplaceHealth(int newHealthPoints, int newHealthPointsCap) {
        var index = GameComponentsLookup.Health;
        var component = CreateComponent<HealthComponent>(index);
        component.healthPoints = newHealthPoints;
        component.healthPointsCap = newHealthPointsCap;
